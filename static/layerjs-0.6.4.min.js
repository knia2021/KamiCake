...
$jscomp.arrayIteratorImpl = function (e) {
    var m = 0;
    return function () {
        return m < e.length ? {done: !1, value: e[m++]} : {done: !0}
    }
};
...
$jscomp.polyfill = function (e, m, l, h) {
    if (m) {
        ...
        h = l[e];
        m = m(h);
        m != h && null != m && $jscomp.defineProperty(l, e, {configurable: !0, writable: !0, value: m})
    }
};
...
$jscomp.polyfill("String.prototype.startsWith", function (e) {
    return e ? e : function (e, l) {
        ...
        e += "";
        var c = h.length, f = e.length;
        l = Math.max(0, Math.min(l | 0, h.length));
        for (var b = 0; b < f && l < c;) if (h[l++] != e[b++]) return !1;
        return b >= f
    }
}, "es6", "es3");
...
$jscomp.polyfill("String.prototype.endsWith", function (e) {
    return e ? e : function (e, l) {
        ...
        void 0 === l && (l = h.length);
        l = Math.max(0, Math.min(l | 0, h.length));
        for (var c = e.length; 0 < c && 0 < l;) if (h[--l] != e[--c]) return !1;
        return 0 >= c
    }
}, "es6", "es3");
(function () {
    ...
    return e
        ...
        1: [function (e, m, l) {
            var h = e("./domhelpers.js"), c = e("./pluginmanager.js"),
                f = e("./parsemanager.js"), b = e("./observer/domobserver.js");
            e = b.extend({
                ...
                registerEventHandlers: function () {
                    ...
                    for (var a = arguments.length, b = 0; b < a; b++) for (var c = Object.keys(arguments[b]), d = 0; d < c.length; d++) h.cssPrefix[c[d]] && (this.outerEl.style[h.cssPrefix[c[d]]] = arguments[b][c[d]]), this.outerEl.style[c[d]] = arguments[b][c[d]]
            ...
            m.exports = e
        }, {"./domhelpers.js": 3, "./observer/domobserver.js": 13, "./parsemanager.js": 20, "./pluginmanager.js": 21}],
        2: [function (e, m, l) {
            m.exports = {
                version: "default",
                defaultDuration: "1s",
                transitionParameters: {duration: "t", type: "p", delay: "d"},
                identifyPriority: {low: 1, normal: 2, high: 3},
                directions2neighbors: {up: "b", down: "t", left: "r", right: "l"},
                neighbors2transition: {b: "auto:up", t: "auto:down", r: "auto:left", l: "auto:right"},
                specialFrames: {
                    none: "!none",
                    left: "!left",
                    right: "!right",
        ...
        3: [function (e, m, l) {
            var h = e("./defaults.js"), c = e("./tmat.js"), f = null, b = {
                ...
                addClass: function (a, b) {
                    ...
                    for (var b = 0; b < a.length; b++) if (a[b]._ljView) return a[b]._ljView
                    ...
                    a = a.match(/^([^?#]*)?(?:\?([^#]*))?(?:#(.*))?$/);
                    return {location: a[1], queryString: a[2], hash: a[3]}
                    ...
                    var g = {};
                    if (a) for (var d in h.transitionParameters) if (h.transitionParameters.hasOwnProperty(d)) {
                        var c = new RegExp("(?:^|[?&])" +
                            h.transitionParameters[d] + "=([^&]+)"), k = a.match(c);
                        k && (g[d] = k[1], !0 !== b && (a = a.replace(c, "")))
                    }
                    return {string: a, transition: g}
                    ...
                    for (var g = 0; g < a.length; ++g) if (a[g] !== b[g]) return a[g - 1];
                    return null
                    ...
                    if ("none" === a || void 0 === a || "FAIL" === a) a = [1, 0, 0, 1, 0, 0]; else {
                        a = a.toLowerCase();
                        var b = a.split("(")[1].split(")")[0].split(",").map(function (a) {
                            return parseFloat(a.replace(/\s+/g, ""))
                        }), c = b[0], d = b[1], f = b[2], k = b[3], q = b[4], e = b[5];
                    ...
                    var k = a.top;
                    var q = a.left;
                    if (0 < c && 90 >= c || -270 > c && -360 <= c) c = c * Math.PI / 180 * -1, k = a.top, q = a.left - Math.sin(c) * g; else if (90 < c && 180 >= c || -180 > c && -270 <= c) k = (180 - c) * Math.PI / 180,
                        q = c * Math.PI / 180, k = a.top - Math.cos(k) * g * -1, q = a.left + (Math.sin(q) * g + -1 * Math.cos(q) * d); else if (0 > c && -90 <= c || 270 < c && 360 >= c) c = -c * Math.PI / 180, k = a.top + Math.sin(c) * d, q = a.left; else if (-90 > c && -180 <= c || 180 < c && 270 >= c) q = (180 - c) * Math.PI / 180, k = -c * Math.PI / 180, q = a.left + Math.cos(q) * d, k = a.top + (Math.sin(k) * d + -1 * Math.cos(k) * g);
                    b.tx = q;
                    b.ty = k;
                    return b
                }
            ...
            m.exports = b
        }, {"./defaults.js": 2, "./tmat.js": 30}],
        4: [function (e, m, l) {
            l = e("./pluginmanager.js");
            var h =
                e("./domhelpers.js"), c = e("./baseview.js");
            e = e("./defaults.js");
            var f = c.extend({
                constructor: function (b) {
                    ...
                    c.prototype.observe.call(this, this.innerEl, {
                        attributes: !0, attributeFilter: ["name", "lj-name", "id"].concat(this.renderRequiredAttributes),
                        children: !0, size: !0
                    })
                }, registerEventHandlers: function () {
                    var b = this;
                    ...
                    var c = b.parent, f = b.getStageDimensions(this), d = this.transformData = {},
                    ...
                    b = this.fitTo(!1) || b.fitTo();
                    -1 === ["responsive", "responsive-width"].indexOf(b) && this.widthSet() && (d.frameWidth = this.getOriginalWidth().computedStyleWidth, d.frameOriginalWidth = this.getOriginalWidth().width, this.widthSet(!1));
                    -1 === ["responsive", "responsive-height"].indexOf(b) && this.heightSet() && (d.frameHeight = this.getOriginalHeight().computedStyleHeight, d.frameOriginalHeight = this.getOriginalHeight().height, this.heightSet(!1));
                    var k = !1, q = !1;
                    switch (b) {
                        case "width":
                ...
                defaultProperties: {type: "frame"}, identify: function (b) {
            ...
            "./baseview.js": 1, "./defaults.js": 2, "./domhelpers.js": 3,
            "./pluginmanager.js": 21
        }],
        5: [function (e, m, l) {
        ...
        6: [function (e, m, l) {
            ...
            l = l.EventManager.extend({
                constructor: function () {
                    ...
                    this.gesture.shift = {
                        x: this.gesture.position.x - this.gesture.start.x, y: this.gesture.position.y -
                ...
                _xPosition: function (c) {
                    ...
                    if (f && this.gesture) {
                        ...
                        if (!this.gesture.direction) {
                            var b = this.gesture.shift.x, a = this.gesture.shift.y;
        ...
        }, {"../../kern/Kern.js": 31, "../layerjs.js": 7, "./gesture.js": 5}],
        7: [function (e, m, l) {
            l = e("./domhelpers.js");
            var h = e("./defaults.js");
            e("./polyfill.js");
            layerJS = {select: l.selectView, imagePath: "/", executeScriptCode: !0, defaults: h};
            m.exports = layerJS
        }, {"./defaults.js": 2, "./domhelpers.js": 3, "./polyfill.js": 22}],
        8: [function (e, m, l) {
            var h = e("./domhelpers.js"), c = e("../kern/Kern.js");
            l = e("./pluginmanager.js");
            var f = e("./layoutmanager.js"), b = e("./scrolltransformer.js"), a = e("./gestures/gesturemanager.js"),
                g = e("./defaults.js"), p = e("./baseview.js"), d = e("./layerjs.js"), n = p.extend({
                    constructor: function (b) {
                        b = b || {};
                        b.childType = "frame";
                        ...
                        })) : (this.currentFrame = null, this.showFrame(g.specialFrames.none, {lastFrameName: ""}));
                        this.autoTrigger()
                    }, startObserving: function () {
                        ...
                        -1 === a["lj-layout-type"] && -1 === a["data-lj-layout-type"] || this.switchLayout(this.layoutType());
                        -1 === a["lj-timer"] && -1 === a["data-lj-timer"] || this.autoTrigger()
                        ...
                        var d = a.scrollElement, k = a.frame.innerEl;
                        if (d && k.contains(d)) {
                        ...
                        return this._layout.setLayerTransform(a, {transition: d ? d + "ms" : ""})
                    }, gestureListener: function (a) {
                        if (!a.event._ljEvtHndld || a.event._ljEvtHndld === this) if (a.event._ljEvtHndld = this, null !== this.currentFrame) {
                            var b = this._transformer.scrollGestureListener(a);
                            if (!a.first) if ("wheel" === a.event.type && (a.preventDefault = !0), !0 === b) a.preventDefault = !1; else if (b) this.setLayerTransform(this.currentTransform = b), this.trigger("scrolled"), a.preventDefault =
                                !0; else if (this.inTransition() && (a.preventDefault = !0), b = this.currentFrame.neighbors(), a.direction) if (b && b[g.directions2neighbors[a.direction]]) {
                                if (a.preventDefault = !0, !this.inTransition() && (a.last || a.wheel && a.enoughDistance())) {
                                    var c = b[g.directions2neighbors[a.direction]];
                                    c.match(/^#/) ? d.router.navigate(c) : this.transitionTo(b[g.directions2neighbors[a.direction]], {type: g.neighbors2transition[g.directions2neighbors[a.direction]]})
                                }
                            } else a.preventDefault = !1, h.debug(a.direction), !b || !b.l && !b.r || "left" !==
                            a.direction && "right" !== a.direction || (a.preventDefault = !0); else a.event.stopPropagation(), a.preventDefault = !0
                        }
                    }, getStageDimensions: function (a) {
                        if (this._layout && this._layout.getStageDimensions) return this._layout.getStageDimensions(a);
                        if (this.parent) return {width: this.parent.width(), height: this.parent.height()}
                        ...
                        var f = b.groupId || (b.groupId = h.uniqueID("group")), k = this.lastgroupId !== f;
                        this.lastgroupId = f;
                            ...
                            var e = function () {
                                ...
                                return d._layout.loadFrame(f).then(function () {
                                    ...
                                    var e = d._transformer.getScrollTransform(g,
                                        b, !0);
                                    if (d.currentFrame === f && d.currentFrameTransformData === g) if (g.scrollX !== k.scrollX || g.scrollY !== k.scrollY) b = c._extend(b, {
                                        applyTargetPrePosition: !1,
                                        applyCurrentPostPosition: !1,
                                        applyCurrentPrePosition: !1,
                                        scrollX: g.scrollX,
                        ...
                        var b = this;
                        a.transitionID === this.transitionID && (h.debug("transition finished", a.transitionID), a.noActivation || (this.currentTransform = this._transformer.getScrollTransform(a.targetFrameTransformData ||
                            {}, a, !1)), this.inTransition(!1), a.noActivation || this.setLayerTransform(this.currentTransform), this.updateClasses(), a.frame && (a.frame.inTransition = !1), h.postAnimationFrame(function () {
                            b.trigger("transitionFinished", a.framename)
                        }))
                    }, _getFrame: function (a, b) {
                        if (a === g.specialFrames.left || a === g.specialFrames.right || a === g.specialFrames.top || a === g.specialFrames.bottom) if (null !== this.currentFrame) {
                        ...
                        if (a === g.specialFrames.none) b = null; else if (b = this.getChildViewByName(a),
                        void 0 === b && void 0 !== a) {
                        ...
                        if (null === this.currentFrame && 0 < a.length) var b = a[0].name(); else if (null !== this.currentFrame && 0 < a.length) {
                        ...
                        var a = this.getChildViews();
                        if (null === this.currentFrame &&
                            0 < a.length) var b = a[0].name(); else if (null !== this.currentFrame && 0 < a.length) {
                        ...
                        for (c = 0; c < b.length; c++) b[c].on("renderRequired", a, {context: this})
                    }
                }, {
                    defaultProperties: {type: "layer"}, identify: function (a) {
        ...
        10: [function (e, m, l) {
            ...
            e = f.extend({
                constructor: function (b) {
                    ...
                    var d = new c.Promise, g = this, k = this.layer.getChildViews(), h = k.length, p, l = function (b, d) {
                        var c = b.getTransformData(g.layer);
                        d = {transition: void 0 !== d ? d : a.duration, opacity: 1, display: "block"};
                    ...
                    var r = a.noActivation ? b : k[h - 1], t = function () {
                        if (a.transitionID === g.layer.transitionID) for (var c = 0; c < (a.noActivation ? 1 : h); c++) p = a.noActivation ? b : k[c], p.applyStyles({transition: "none"});
                        d.resolve()
                    };
                    ...
                    a.semaphore.sync().then(function () {
                        if (null !== b) if (a.noActivation) l(b); else {
                            g._reverseTransform = g._calculateReverseTransform(b, f);
                            for (var d = 0; d < h; d++) l(k[d])
                        } else for (d = 0; d < h; d++) p = k[d], p.applyStyles({opacity: 0, transition: a.duration});
                        "" === a.duration && t()
                    });
                    return d
                }, _calculateReverseTransform: function (b, a) {
                    var c = parseInt(b.x(), 10) || 0, f = parseInt(b.y(), 10) || 0, d = b.rotation() || 0;
                    ...
                    var f = this.layer.getChildViews(), e = f.length, d = new c.Promise;
            ...
            m.exports = e
        }, {"../../kern/Kern.js": 31, "../domhelpers.js": 3, "../layoutmanager.js": 9, "./layerlayout.js": 11}],
        11: [function (e, m, l) {
            var h = e("../domhelpers.js"), c = e("../../kern/Kern.js"), f = e("../tmat.js");
            e = c.EventManager.extend({
                constructor: function (b) {
                    ...
                    if (null === b || b.document.body.contains(b.outerEl) && "none" !== g(b.outerEl).display && b.parent === this.layer) a.resolve(); else if (b.parent !== this.layer) {
                        g = this.layer.outerEl;
                        var e = h.commonParent(b.innerEl, g), d = function (a, b) {
                            var c = new f;
                        ...
                        b.applyStyles({transform: g.transform_nomatrix(), top: "0px", left: "0px"});
            ...
            m.exports = e
        }, {"../../kern/Kern.js": 31, "../domhelpers.js": 3, "../tmat.js": 30}],
        12: [function (e, m, l) {
            var h = e("../domhelpers.js"), c = e("../../kern/Kern.js");
            l = e("../layoutmanager.js");
            var f = e("./layerlayout.js"), b = ["adjacent", 0, 0, 1, 0];
            e = ["adjacent", -1, 0, 1, 0];
            var a = ["adjacent", 1, 0, 1, 0], g = ["adjacent", 0, 1, 1, 0], p = ["adjacent", 0, -1, 1, 0],
                d = ["adjacent", 0, 0, 1, 0, {opacity: 0}],
                n = ["adjacent", 0, 0, 1, 0, {filter: "blur(5px)", opacity: 0}, {filter: "blur(0px)"}],
                k = ["adjacent", 0, 0, .666, 0, {opacity: 0}], q = ["adjacent", 0, 0, 1.5, 0, {opacity: 0}], z = {
                    default: [a, e, 1],
                    none: [b, b, 1],
                    left: [a, e, 1],
                    right: [e, a, 1],
            ...
            e = f.extend({
                constructor: function (a) {
                    ...
                    for (var d = this.layer.getChildViews(), c = 0; c < d.length; c++) d[c] !== b && d[c] !== a && null !== d[c].outerEl.parentNode && d[c].applyStyles({display: "none"})
                },
                transitionTo: function (a, b, d, f) {
                    var g = this, e = g.layer.currentFrame;
                    return this.prepareTransition(a, b, d, f).then(function (k) {
                        var n = new c.Promise, p = 0, q = function (a, d) {
                        ...
                        b.semaphore.sync().then(function () {
                            var c = {
                                transition: b.duration, top: "0px", left: "0px", opacity: "1", width: d.frameOriginalWidth,
                        ...
                        return n
                                                ...
                                                d, f, g) {
                    var e = new c.Promise, k, n = this.layer.currentFrame;
                    ...
                    if (!k) {
                        ...
                        if ("function" === typeof p) k = p(d.type, this.layer.currentFrameTransformData, f); else if (Array.isArray(p)) {
                        ...
                        g = {transition: "none", visibility: "inital"};
                    ...
                    return {
                        transform: "translate3d(" + -a.shiftX + "px," + -a.shiftY + "px,0px) scale(" +
                            a.scale + ")", opacity: 1
                    }
                }, genericTransition: function (a, b, d, f, g) {
                    var e = this, k = function (a, b, d, f) {
                        var g = e.getStageWidth(), k = e.getStageHeight(), n = -b.shiftX, h = -b.shiftY, p = -d.shiftX,
                            q = -d.shiftY, m = a[1], l = a[2], z = a[3], A = a[4], u = a[5] || {};
                        switch (a[0]) {
                            case "adjacent":
                    ...
                    n = {t1: c._extend(this._calcFrameTransform(f), n), c0: c._extend(this._calcFrameTransform(d), h)};
        ...
        13: [function (e, m, l) {
            var h = e("../../kern/Kern.js"), c = e("./observerfactory.js");
            e = h.EventManager.extend({
                constructor: function () {
                    h.EventManager.call(this)
                    ...
                    b.size && (this._sizeObserver = c.getSizeObserver(f, {
                        timeout: b.timeout, callback: function () {
            ...
            m.exports = e
        }, {"../../kern/Kern.js": 31, "./observerfactory.js": 17}],
        14: [function (e, m, l) {
            var h = e("./observer.js");
            e = h.extend({
                constructor: function (c, f) {
                    ...
                    if (this.options.attributeFilter && c.attributes && 0 < Object.getOwnPropertyNames(c.attributes).length) {
                        var f = {}, b;
                        for (b in c.attributes) if (c.attributes.hasOwnProperty(b)) for (var a = b.toUpperCase(), g = 0; g < this.options.attributeFilter.length; g++) {
        ...
        15: [function (e, m, l) {
            ...
            e = h.extend({
                constructor: function (c, f) {
                    ...
                    for (var f = {attributes: [], addedNodes: [], removedNodes: []}, b = 0; b < c.length; b++) {
                        var a = c[b];
                        ...
                        if (this.options.childList && "childList" === a.type) {
                            if (a.addedNodes &&
                                0 < a.addedNodes.length) for (var g = 0; g < a.addedNodes.length; g++) f.addedNodes.push(a.addedNodes[g]);
                            if (a.removedNodes && 0 < a.removedNodes.length) for (g = 0; g < a.removedNodes.length; g++) f.removedNodes.push(a.removedNodes[g])
                        }
                    }
                    ...
                    0 === this.counter && (1 === this.element.nodeType && this.options.attributes && this._initalizeAttributes(), this.mutationObserver.observe(this.element, {
                        attributes: this.options.attributes || !1, childList: this.options.childList ||
                            !1, characterData: this.options.characterData || !1
                    }))
                }, stop: function () {
        ...
        17: [function (e, m, l) {
            l = e("../../kern/Kern.js");
            var h = e("./mutationsobserver.js"), c = e("./timeoutobserver.js"), f = e("./sizeobserver.js");
            e = l.Base.extend({
                constructor: function () {
            ...
            "../../kern/Kern.js": 31, "./mutationsobserver.js": 15,
            "./sizeobserver.js": 18, "./timeoutobserver.js": 19
        }],
        18: [function (e, m, l) {
            var h = e("./observer.js");
            e = h.extend({
                constructor: function (c, f) {
                    ...
                    0 === this.counter && (this.dimensions = {
                        ...
                        }, size: {width: this.element.clientWidth, height: this.element.clientHeight}
                    }, this.checkSize())
                }, stop: function () {
                    this.counter++;
                    ...
                    var c = this.element, f = c.scrollWidth, b = c.scrollHeight, a = c.clientWidth;
                    c = c.clientHeight;
                    if (a !== this.dimensions.size.width || c !== this.dimensions.size.height || f !== this.dimensions.size_inner.width || b !== this.dimensions.size_inner.height) this.dimensions.size = {
                        width: a,
                        height: c
                    }, this.dimensions.size_inner = {width: f, height: b}, this._invokeCallBack();
                    var g = this;
        ...
        19: [function (e, m, l) {
            ...
            e = h.extend({
                constructor: function (c, f) {
                    ...
                    var c = {attributes: {}, addedNodes: [], removedNodes: [], characterData: !1};
        ...
        20: [function (e,
                       m, l) {
            var h = e("./pluginmanager.js"), c = e("./domhelpers.js"), f = e("../kern/Kern.js");
            layerJS.parseManager = new function () {
                ...
                this._parse = function (b, a, g) {
                    ...
                    for (var d = layerJS.getState(a), n = 0; n < e; n++) {
                        var k = h.createView(c.getAttributeLJ(b[n], "type"), f._extend(g, {el: b[n], document: a}));
                        d.registerView(k)
                    }
                }
            };
            m.exports = layerJS.parseManager
        }, {"../kern/Kern.js": 31, "./domhelpers.js": 3, "./pluginmanager.js": 21}],
        21: [function (e, m, l) {
            l = e("./layerjs.js");
            var h = e("../kern/Kern.js");
            e = h.EventManager.extend({
                constructor: function (c, f) {
                    ...
                    this.map[c] = {view: f, identify: f.identify};
                    ...
                    for (var f, b = Object.keys(this.identifyPriorities).sort(function (a, b) {
                        ...
                        for (var g = b[a], e = 0; e < this.identifyPriorities[g].length; e++) if (this.identifyPriorities[g][e].identify(c)) {
        ...
        23: [function (e, m, l) {
            var h = e("../../kern/Kern.js"), c = e("../parsemanager.js"), f = e("../domhelpers.js"),
                b = e("./staticrouter.js");
            e = b.extend({
                constructor: function (a) {
                    a = a || {};
                    ...
                    b.prototype.handle.call(this, a).then(function (b) {
                        b.handled || b.optout ? p.resolve(b) : e._loadHTML(f.joinUrl(a, !0)).then(function (b) {
                            ...
                            var l = n.exportState(), r = l.filter(function (a) {
                                var b = a.split(".").pop().startsWith("!"), c = a;
                                b && (c = a.replace(/\.[^\.]*$/, ""));
                            ...
                            e.addRoute(f.joinUrl(a, !0),
                                {state: l, pageTitle: b.title});
                            f.postAnimationFrame(function () {
                                p.resolve({stop: !1, handled: !0, paths: r, transitions: t})
                            })
                        }, function () {
                            p.resolve({stop: !1, handled: !1, paths: [], transitions: []})
                        })
                    });
                    return p
            ...
            m.exports = e
        }, {"../../kern/Kern.js": 31, "../domhelpers.js": 3, "../parsemanager.js": 20, "./staticrouter.js": 26}],
        24: [function (e, m, l) {
            var h = e("../../kern/Kern.js"), c = e("../domhelpers.js");
            e = h.EventManager.extend({
                handle: function (f) {
                    var b = new h.Promise;
                    if (void 0 === f.hash || "#" === f.hash || "" === f.hash) b.resolve({
                        ...
                        for (var a = (f.hash.startsWith("#") ? f.hash.substr(1) : f.hash).split(";"), e = [], p = [], d = layerJS.getState(), n = function (a) {
                            ...
                            var q = a[k].split("?")[0].split("&")[0].replace("(", "").replace(")", ""),
                                m = c.parseStringForTransitions(a[k]), l = !1;
                            try {
                            ...
                            if (!l && (l = (l = document.getElementsByName(q)) && l[0] || document.getElementById(q)) && "none" !== window.getComputedStyle(l).display && (r = c.findParentViewOfType(l,
                                "frame"), void 0 !== r)) {
                                var u = d.buildPath(r.outerEl, !1), v = e.indexOf(u);
                                if (-1 !== v) var w = p[v]; else if (-1 === v && (u = u.replace(/\.[^\.]*$/, ""), u = f.paths.filter(n(u)), 1 === u.length)) {
                        ...
                        b.resolve({stop: !1, handled: 0 < e.length, paths: e, transitions: p})
                    }
                    return b
                }, buildUrl: function (c) {
                    for (var b = layerJS.getState(), a = [], f = 0; f < c.state.length; f++) {
                        var e = c.state[f].split("."), d = void 0, n = !1;
                        do {
                            d = e.pop() + (d ? "." + d : "");
            ...
            m.exports = e
        }, {"../../kern/Kern.js": 31, "../domhelpers.js": 3}],
        25: [function (e, m, l) {
            var h = e("../layerjs.js"), c = e("../domhelpers.js"), f = e("../../kern/Kern.js"), b = e("./staticrouter.js");
            e = f.EventManager.extend({
                constructor: function (a) {
                    ...
                    this.state.on("stateChanged", this._stateChanged, {context: this})
                    ...
                    window.onpopstate = function (b) {
                        document.location.href === a.ignoreUrl ? delete a.ignoreUrl : b && b.state && b.state.state ? a.state.transitionTo(b.state.state, b.state.transitions,
                            {noHistory: !0}) : a.navigate(document.location.href, null, !0)
                    };
                    c.addDelegtedListener(this.rootElement, "click", "a:not([data-lj-no-link='true']):not([lj-no-link='true'])", function (b) {
                        ...
                        if ("" !== this.href && !this.href.startsWith("javascript:")) {
                            var d = this.getAttribute("href"), e = this.getAttribute("target");
                            e && "_self" !== e || (b.preventDefault(), a.navigate(d, c.findParentViewOfType(this, "layer")).then(f))
                        }
                    })
                }, navigate: function (a,
                                       b, e, d) {
                    var g = f._extend(c.splitUrl(a), {transitions: [], context: b, paths: [], globalTransition: {}});
                    ...
                    var k = this.routers.length, h = this, p = new f.Promise, l = !1, m = function () {
                        l && (!0 === d ? h.state.showState(g.paths, g.transitions, {
                            ...
                            g.transitions, {paths: g.paths, transitions: g.transitions, noHistory: e, originalUrl: a}));
                        p.resolve(l)
                    }, r = function (a) {
                    ...
                    var e = a && a.exportMinimizedState() || {state: [], defaultState: [], omittedState: []};
        ...
        }, {"../../kern/Kern.js": 31, "../domhelpers.js": 3, "../layerjs.js": 7, "./staticrouter.js": 26}],
        26: [function (e, m, l) {
            var h = e("../../kern/Kern.js"), c = e("../domhelpers.js");
            e = h.EventManager.extend({
                constructor: function () {
                    ...
                    var b = c.joinUrl(f, !0), a = !b || !f.explLoc && c.joinUrl(c.splitUrl(window.location.href), !0) === b;
                    var e = a ? !1 : this.hasRoute(b);
                    var p = new h.Promise, d = [], n = [];
                    e && (d = this.routes[b].state, d.forEach(function () {
                        n.push(h._extend({}, f.globalTransition))
                    }));
                    p.resolve({stop: !1, handled: e, transitions: n, optout: a, paths: d});
                    return p
                }, buildUrl: function (f) {
                    var b = f.state.concat(f.defaultState), a = this, e = c.joinUrl(f, !0);
                    var h = e;
                    var d = function (b) {
                        return a.routes[e] && -1 !== a.routes[e].state.indexOf(b)
                    }, n = b.filter(d), k = n.length;
                    for (e in this.routes) if (this.routes.hasOwnProperty(e) && this.routes[e].state.length > k) {
                        var q = b.filter(d), l = q.length;
                        l > k && (n = q, k = l, h = e)
                    }
                    ...
                    n.forEach(function (a) {
                        var b =
                            f.state.indexOf(a);
                        -1 !== b ? f.state.splice(b, 1) : f.defaultState.splice(f.defaultState.indexOf(a), 1)
                    })
                }
            });
            m.exports = e
        ...
        27: [function (e, m, l) {
            ...
            e = h.EventManager.extend({
                ...
                getScrollTransform: function (e, b, a) {
                    var f = b.scrollX || e.scrollX, h = b.scrollY || e.scrollY;
        ...
        28: [function (e, m, l) {
            l = e("./pluginmanager.js");
            var h = e("./gestures/gesturemanager.js"), c = e("./defaults.js"), f = e("./domhelpers.js"),
                b = e("./baseview.js"), a = b.extend({
                    constructor: function (a) {
                        a = a || {};
                        a.childType = "layer";
                        b.call(this, a);
                        ...
                        b.prototype.observe.call(this, this.innerEl, {attributes: !0, children: !0, size: !0})
                    }, _renderChildPosition: function (a) {
                        1 === a.nodeType() && (a.unobserve(), a.outerEl.style.left = "0px", a.outerEl.style.top = "0px", a.startObserving())
                    }, _parseChildren: function (a) {
                        var c = this, d = this.autoWidth() || this.autoHeight(), e = function (a) {
                            return function (b,
                                             d) {
                                d = d || {};
                                b = a.currentFrameTransformData;
                                d = {transition: d.duration || ""};
                    ...
                    defaultProperties: {type: "stage"}, identify: function (b) {
        ...
        29: [function (e, m, l) {
            var h = e("../kern/Kern.js");
            l = e("./layerjs.js");
            var c = e("./domhelpers.js"), f = h.EventManager.extend({
                constructor: function (b) {
                    this.document =
                        b || document;
                    ...
                    if (b.document.body.contains(b.outerEl)) {
                        ...
                        if (this.views[a]) {
                            ...
                            b.on("attributesChanged", this._attributesChangedEvent(b), {context: this});
                    ...
                    b = b || !1;
                    var a = {state: [], defaultState: [], omittedState: []}, c = this;
                    ...
                    var a = this, e = Object.keys(this.views).map(function (b) {
                    ...
                    a.map(function (a) {
                        ...
                        for (var d = 0; d < a.length; d++) {
                            ...
                            if (!0 !== c.noActivation || c.isInterStage) g[c.path] = {
                                ...
                                transition: h._extend({noActivation: c.noActivation}, l, n)
                            }
                        }
                    });
                    a = Object.getOwnPropertyNames(g);
                    var p = new h.Semaphore(a.length), y = c.uniqueID("group");
                    this._transitionGroup[y] = {length: a.length, payload: f};
                    ...
                    for (var a =
                        [b]; b = b.replace(/^[^\.]*\.?/, "");) a.push(b);
                    return a
                }, resolvePath: function (b, a) {
                    var c = b.endsWith("$");
                    c && (b = b.substr(0, b.length - 1));
                    var e = a && this.buildPath(a), d = b.split(".");
                    a = d.pop();
                    var f = "!" === a[0];
                    var k = d.join(".");
                    ...
                    for (k = 0; k < d.length; k++) {
                        ...
                        if (f) {
                            ...
                            e.push({layer: h, frameName: a, path: l + "." + a + (c ? "$" : "")})
                            ...
                            noActivation: c
                        }); else if ("layer" === h.type()) if (l.endsWith(b)) e.push({view: h, path: l}); else {
                            var m =
                                this.resolvePath(a);
                            1 === m.length && e.push({
                                layer: h,
            ...
            m.exports = f
        }, {"../kern/Kern.js": 31, "./domhelpers.js": 3, "./layerjs.js": 7}],
        30: [function (e,
                       m, l) {
            var h = function (c) {
            ...
            h.prototype = {
                prod: function (c) {
                    ...
                    var e = this.get_translation_equal(), b = this.get_scale_equal(), a = this.get_rotation_equal();
                    ...
                    return {x: this.a * c.x + this.b * c.y + this.tx, y: this.c * c.x + this.d * c.y + this.ty}
                }, invert: function () {
                    var c =
                        1 / (this.a * this.d - this.b * this.c || 1), e = c * this.d, b = -c * this.b, a = -c * this.c;
                    c *= this.a;
                    return new h([e, b, a, c, -e * this.tx - b * this.ty, -a * this.tx - c * this.ty])
                }, get_scale_equal: function () {
                    var c = this.a, e = this.c;
            ...
            (function () {
                var e = function () {
                    ...
                    var e = function (a) {
                        ...
                        for (var d = 1; d < b; d++) for (var c = Object.keys(arguments[d]), e = 0; e < c.length; e++) a[c[e]] = arguments[d][c[e]];
                        return a
                    }, b = function (a) {
                        if ("object" === typeof a) {
                            if (Array.isArray(a)) {
                        ...
                        _extend: e, _extendKeep: function (a) {
                            var b = arguments.length;
                            if (2 > b) throw"too few arguments in _extend";
                            if (null === a) throw"no object provided in _extend";
                            for (var d = 1; d < b; d++) for (var c = Object.keys(arguments[d]), e = 0; e < c.length; e++) a.hasOwnProperty(c[e]) || (a[c[e]] = arguments[d][c[e]]);
                            return a
                        }, _extendKeepDeepCopy: function (a) {
                            var d = arguments.length;
                            if (2 > d) throw"too few arguments in _extend";
                            if (null === a) throw"no object provided in _extend";
                            for (var c = 1; c < d; c++) for (var e = Object.keys(arguments[c]), f = 0; f < e.length; f++) a.hasOwnProperty(e[f]) || (a[e[f]] = b(arguments[c][e[f]]));
                            return a
                        }
                    }, g = a.Base = function () {
                    };
                    g.extend = function (a, b) {
                        a = a || {};
                        b = b || {};
                        var d = this, f = a.hasOwnProperty("constructor") ? a.constructor : function () {
                    ...
                    a.EventManager = g.extend({
                        constructor: function () {
                            ...
                            this.__listeners__[a].push({callback: b, options: c || {}});
                            return this
                        }, once: function (a, b, c) {
                            ...
                            if (a) if (b || c) {
                                ...
                                for (a = 0; a < d.length; a++) b && d[a].callback !== b || c && d[a].options.context !== c || d.splice(a,
                                    1)
                            } else delete this.__listeners__[a]; else if (b || c) for (var e in this.__listeners__) {
                                if (this.__listeners__.hasOwnProperty(e)) for (d = this.__listeners__[e], a = 0; a < d.length; a++) b && d[a].callback !== b || c && d[a].options.context !== c || d.splice(a, 1)
                            } else this.__listeners__ = {};
                            return this
                        }, trigger: function (a) {
                            if (this.__listeners__[a]) for (var b = 0; b < this.__listeners__[a].length; b++) {
                            ...
                            if (this.__listeners__[b]) for (var d = 0; d < this.__listeners__[b].length; d++) if (!this.__listeners__[b][d].options.ignoreSender || this.__listeners__[b][d].options.ignoreSender !== a) {
                    ...
                    var h = a.Promise = g.extend({
                        constructor: function () {
                            ...
                            if (void 0 !== this.state) console.warn("Promise: double resolve/reject (ignored)."); else return this.state = !0, this.value = a, this.execute(), this
                        }, reject: function (a) {
                            if (void 0 !== this.state) console.warn("Promise: double resolve/reject (ignored)."); else return this.state = !1, this.reason = a, this.execute(), this
                        }, execute: function () {
                            if (this.nextPromise) {
                                var a = this;
                                if (!0 === this.state) {
                    ...
                    a.Queue = g.extend({
                        constructor: function () {
                            ...
                            if (this.waiting) {
                                ...
                                this.q.push({promise: c, category: b})
        ...
        32: [function (e, m, l) {
            ...
            var h = window.location.href, c = e("./framework/router/filerouter.js"),
                f = e("./framework/router/hashrouter.js"), b = e("./framework/domhelpers.js"), a = !1;
            layerJS.init = function () {
                if (!a) {
                    a = !0;
                    layerJS.parseManager.parseDocument();
                    var e = b.getAttributeLJ(document.body, "router");
                    e && "filerouter" === e.toLowerCase() && layerJS.router.addRouter(new c({cacheCurrent: !0}));
